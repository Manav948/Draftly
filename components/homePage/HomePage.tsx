import { homePageAssignmentFilterAndStarredImgs, homePageCalendarImgs, homePageChatImgs, homePageMindMapsImgs, homePagePomodoroImgs, homePageRolesAndSettingsImgs, homePageTasksImgs } from "@/lib/constants";
import { Nav } from "./navbar/Nav";
import { Header } from "./header/Header";
import { TextSection } from "./textSection/TextSection";
import { Section } from "./section/Section";
import { Footer } from "./footer/Footer";
import OrbitLogos from "../ui/OrbitImage";
      ...
      <div className="w-full mx-auto max-w-screen-xl px-4 sm:px-6">
        ...
        <main>
          <TextSection
            ...
            desc="Maximize your team’s efficiency with Draftly—an all-in-one workspace designed to consolidate your essential tools into one cohesive platform."
          />
          ...
          <Section
            ...
            desc="Draftly’s role management system simplifies workspace oversight. Admins and owners can adjust user roles, manage account and workspace settings, and oversee permissions to ensure smooth collaboration."
          ...
          <TextSection
            ...
            desc=" Effortlessly share projects and invite others to join with easy shareable links. Draftly enables instant project review and real-time chatting with team members from anywhere."
          />
          <div className="mt-50">
            <OrbitLogos />
          </div>
